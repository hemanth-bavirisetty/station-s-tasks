    ...
    <div className="bg-gradient-to-b from-[#2962FF] to-white h-screen w-screen">
      <div className=" mx-auto p-4 pt-6 md:p-6 lg:p-12 xl:p-24 ">
        ...
        <div className="w-full lg:w-1/2  p-6 ">
          <h1 className="text-6xl md:text-7xl text-white font-bold font-montserrat">Take Control of Your Workflow with Task Manager</h1>
          <p className="text-2xl py-2 md:pt-10 text-white font-open-sans">Streamline your tasks, boost productivity, and stay organized with our intuitive task management system.</p>
          <div className='py-10'>
